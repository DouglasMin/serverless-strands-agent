...
### 3. Unified Workspace Studio & In-Browser Previews
...
* **High-Res Mermaid Diagram Lightbox**: Zoom diagrams up to 400% with full-screen modal viewing.
...
## 📄 License
MIT License. Built with ❤️ for next-generation agentic workflows.
